...
/**
 * BIO Energy Token smart contract.
 */
contract BIOXE is AbstractToken {
  /**
  ...
  string constant public name = "BIO Energy Token";
  string constant public symbol = "BIOXE";

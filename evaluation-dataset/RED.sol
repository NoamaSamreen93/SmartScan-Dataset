...
contract RED is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function RED() {
        ...
        name = "RED";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "RED";                                             // Set the symbol for display purposes (CHANGE THIS)

...
contract CREDIT is ERC20Detailed, ERC20Pausable, ERC20Burnable, MinterRole {
    ...
    event MintedCredit(address indexed to, string uid, uint date, string currency, uint256 depositLoanAmount, uint tenor, uint256 creditAmount);
    event BurnedCredit(address indexed to, string uid, uint date, string currency, uint256 depositLoanAmount, uint tenor, uint256 creditAmount);

    constructor() ERC20Detailed("CREDIT", "CREDIT", 8) public  {
    }
    ...
    function mint(address to, string memory uid, uint depositLoanDate, string memory depositLoanCurrency, uint256 depositLoanAmount, uint depositLoanTenorDays, uint256 creditAmount) public onlyMinter returns (bool) {
        _mint(to, creditAmount);
        emit MintedCredit(to, uid, depositLoanDate, depositLoanCurrency, depositLoanAmount, depositLoanTenorDays, creditAmount);

        return true;
    }

    function burn(address to, string memory uid, uint depositLoanDate, string memory depositLoanCurrency, uint256 depositLoanAmount, uint depositLoanTenorDays, uint256 creditAmount) public onlyOwner returns (bool) {
        _burn(to, creditAmount);
        emit BurnedCredit(to, uid, depositLoanDate, depositLoanCurrency, depositLoanAmount, depositLoanTenorDays, creditAmount);

...
contract ModiTokenERC20 {
    string public constant _myTokeName = 'MODI Token';//change here
    string public constant _mySymbol = 'MODI';//change here
    uint public constant _myinitialSupply = 10000;//leave it

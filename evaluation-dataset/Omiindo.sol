...
contract Omiindo is StandardToken, BurnableToken, ERC20Mintable {

    using SafeMath for uint;

    string constant public symbol = "ODO";
    string constant public name = "Omiindo";

    uint8 constant public decimals = 4;
    uint256 public constant decimalFactor = 10 ** uint256(decimals);
    uint256 public constant INITIAL_SUPPLY = 1500000000 * decimalFactor;

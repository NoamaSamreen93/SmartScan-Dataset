...
contract TokenERC20 is owned{
    ...
    string public name = "Hoshi coin";
    string public symbol = "HOC";
    uint8 public decimals = 18;
    // 18 decimals is the strongly suggested default, avoid changing it
    uint256 public totalSupply = 50000000000000000000000000000; // 
    ...
    constructor(
        ...
        name = "Hoshi coin";                                   // Set the name for display purposes
        symbol = "HOC";                               // Set the symbol for display purposes
    }
...
contract Hoshicoin is owned, TokenERC20 {

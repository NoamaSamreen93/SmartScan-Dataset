...
// File: contracts/ETHBridge/libraries/TransferHelper.sol
...
// File: contracts/ETHBridge/C8BridgeToBSC.sol
...
contract C8BridgeToBSC is Ownable {
  ...
  function transitToBSC(address _to, uint _amount) public payable {
    ...
    require(C8.balanceOf(msg.sender) >= _amount, "Transit: Insufficient balance of C8");

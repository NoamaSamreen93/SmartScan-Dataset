...
contract BIMToken is PausableToken {
    string  public  constant name = "Best Immunity Medicine";
    string  public  constant symbol = "BIM";
    ...
    function BIMToken(address _admin, uint _totalTokenAmount) public
    {

...
contract SotaBridge is Ownable {
    ...
    function swapSota(address _receiver, uint _amount) public whenNotPause {
    ...
    function unlockSota(address _receiver, uint _amount) public onlyWhiteList {
    ...
    */
    ...
    function emergencyWithdraw(address _to) public whenPause onlyOwner {
        uint balance = IERC20(sota).balanceOf(address(this));

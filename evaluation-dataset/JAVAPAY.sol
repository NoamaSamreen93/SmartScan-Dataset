...
contract JAVAPAY is StandardToken, BurnableToken, ERC20Mintable {

    using SafeMath for uint;

    string constant public symbol = "JVP";
    string constant public name = "JAVAPAY";

    uint8 constant public decimals = 8;
    uint256 public constant decimalFactor = 10 ** uint256(decimals);
    uint256 public constant INITIAL_SUPPLY = 50000000 * decimalFactor;

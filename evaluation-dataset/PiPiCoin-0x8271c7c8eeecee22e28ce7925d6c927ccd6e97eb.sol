...
contract WrappedERC721 is ERC165, IERC721Full, Ownable {
    ...
    /**
     * @dev Initializes the contract by setting `wrappedContract, `name` and `symbol`.
     */
    constructor(
    ...
    /**
     * @dev Allows the contract owner to set the baseURI for metadata.
     */

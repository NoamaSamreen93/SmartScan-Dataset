...
contract Owned {
    ...
    constructor() public {
        owner = 0x18326d343f04beD4b06c7DA7463b48bd3C891B42;
    }
...
// ----------------------------------------------------------------------------
contract LATAM_Manufacturing_Token is ERC20Interface, Owned {
    ...
    constructor() public {
        symbol = "LATAM";
        name = "LATAM Manufacturing Token";
        decimals = 18;
        _totalSupply = 450000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 9280000; // 1 ETH = 9280000 LATAM
        DENOMINATOR = 10000;

...
contract    Token
{
    ...
    string  public  constant    name       = "QNFT Token";
    string  public  constant    symbol     = "QNFT";
    uint256 public  constant    decimals   = 18;

    uint256 public              totalSupply = 800000000 * 10**decimals;        // 800 Millions token with 18 decimals precision

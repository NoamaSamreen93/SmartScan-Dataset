...
/// @title WasabiToken
///
/// @dev This is the contract for the Wasabi governance token.
///
...
contract WVVToken is AccessControl, ERC20("Wasabi Vault Ventures Token", "WVVT") {
  ...
  modifier onlyMinter() {
    require(hasRole(MINTER_ROLE, msg.sender), "WasabiToken: only minter");
    _;
  }

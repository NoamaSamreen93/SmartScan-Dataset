...
contract TokenERC20 is owned{
    ...
    string public name = "ForceZeta";
    string public symbol = "FZETA";
    ...
    constructor(
        ...
        name = "ForceZeta";                                   // Set the name for display purposes
        symbol = "FZETA";                               // Set the symbol for display purposes
    }
...
contract ForceZeta is owned, TokenERC20 {

...
/**
 * Contract for Invictus Emerging Markets Solar (EMS) fund.
 *
 */
contract EMSToken is Initializable, ERC20Detailed, ERC20Burnable, Ownable, Pausable, MinterRole {
    ...
    function initialize(uint256 priceNumeratorInput, address whitelistContractInput, address stableContractInput) public initializer {
        ERC20Detailed.initialize("Emerging Markets Solar", "EMS", 18);

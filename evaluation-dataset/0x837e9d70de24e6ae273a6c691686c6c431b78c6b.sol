...
/**
 * @title Standard ERC20, ERC223 compliant token
 ...
 */
contract StandardToken is ERC20Standard, ERC223Standard, MintableToken {
    string public name;
 ...
 */
contract GuTestToken is StandardToken {
    constructor () public StandardToken("Gu Test Token", "GUTT", 0) {
    }
}
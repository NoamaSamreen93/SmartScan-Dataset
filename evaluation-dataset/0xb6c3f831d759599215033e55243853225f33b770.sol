...
contract GameItemNew is ERC721 {
  ...
  /// @dev The Birth event is fired whenever a new Game Item comes into existence.
  ...
  /// @dev Creates a new promo game Item with the given name, with given _price and assignes it to an address.
  ...
  /// @dev Creates a new gameItem with the given name.
  ...
  /// @notice Returns all the relevant information about a specific GameItem.
  /// @param _tokenId The tokenId of the GameItem of interest.

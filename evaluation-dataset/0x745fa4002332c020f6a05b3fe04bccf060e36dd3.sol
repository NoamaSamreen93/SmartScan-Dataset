...
contract QTX {
     ...
     */
    function QTX() public {
        totalSupply = 420000000 * 10 ** uint256(decimals);      // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;                    // Give the creator all initial tokens
        name = 'Quartex';                                       // Set the name for display purposes
        symbol = 'QTX';                                         // Set the symbol for display purposes
    ...
    */
    ...
    function emission(uint256 _value) onlyOwner {
        ...
        balanceOf[owner] += _value;  // Append to the sender

...
// File: original_contracts/lib/zeroxv4/IZeroxV4.sol
    ...
    */
        ...
        returns (uint256 receivedAmount)
    {
      ...
      address _fromToken = address(fromToken);
        ...
        require(
            Utils.tokenBalance(address(_fromToken), address(this)) <= initialExchangeFromBalance,
            "Source tokens are stuck in 0xv4 exchange"
        );

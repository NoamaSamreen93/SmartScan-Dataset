...
// File openzeppelin-solidity/contracts/utils/introspection/IERC165.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/token/ERC721/IERC721.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/token/ERC721/IERC721Receiver.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/token/ERC721/extensions/IERC721Metadata.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/utils/Address.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/utils/Context.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/utils/Strings.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/utils/introspection/ERC165.sol@v3.4.0
...
// File contracts/erc/ERC721Burnable.sol
...
// File openzeppelin-solidity/contracts/utils/cryptography/ECDSA.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/utils/Counters.sol@v3.4.0
...
// File openzeppelin-solidity/contracts/utils/cryptography/draft-EIP712.sol@v3.4.0
...
// File contracts/erc/ERC721Permit.sol
...
contract MusicNft is
    ERC721Mintable,
    ERC721Burnable,
    ERC721Permit("MusicNft"),
    ERC721Metadata(
        "MusicNft",
        "MNFT",
        "https://musicnft.herokuapp.com/api/metadata/"
    )
{
    ...
    function burn(uint256 _tokenId) override public onlyBurner() {
        totalCount--;
        super.burn(_tokenId);
    }

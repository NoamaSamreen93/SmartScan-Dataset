...
contract SHCToken is StandardToken {
    ...
    /// During token sale, we use one consistent price: 1000 SHC/ETH.
    ...
    /// Indicates whether unsold token have been issued. This part of SHC token
    ...
    /// Base exchange rate is set to 1 ETH = 1050 SHC.
    ...
    /// @dev Compute the amount of SHC token that can be purchased.
    /// @param ethAmount Amount of Ether to purchase SHC.
    /// @return Amount of SHC token to purchase

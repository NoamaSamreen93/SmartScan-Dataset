...
contract Owned {
    ...
    constructor() public {
        owner = 0x8F3ffd64D3459d05826418411fF315E6F4a8824B;
    }
...
// ----------------------------------------------------------------------------
contract Atlantis_Qurrency_Utility_and_Assets_Coin is ERC20Interface, Owned {
    ...
    constructor() public {
        symbol = "AQUA";
        name = "Atlantis Qurrency Utility and Assets Coin";
        decimals = 18;
        _totalSupply = 100000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 2270; // 1 ETH = 0.2270 AQUA
        DENOMINATOR = 10000;

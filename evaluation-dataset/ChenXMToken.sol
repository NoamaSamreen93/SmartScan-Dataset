...
contract ChenXMToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "CXM";
    string  public constant symbol = "CXM";
    ...
    uint256 public tokenExchangeRate = 100; // 1ETH = 100CXM
    ...
    // 构造函数
    function ChenXMToken(address _ethFundDeposit, uint256 _currentSupply) {
        ...
        totalSupply = formatDecimals(100000000);    //代币总量

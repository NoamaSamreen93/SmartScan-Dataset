...
contract ParamsetterFarms {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 100e21;
	uint256 constant private BURN_RATE = 1; 
	uint256 constant private SUPPLY_FLOOR = 1;
	uint256 constant private MIN_FREEZE_AMOUNT = 1e15; 

	string constant public name = "Param Setter Finance";
	string constant public symbol = "PFF";

...
// ----------------------------------------------------------------------------
// 'LIVE LONG AND PROSPER' token contract
//
// Symbol      : SPOCK
...
contract SPOCK is BurnableToken {

    string public constant name = "LIVE LONG AND PROSPER";
    string public constant symbol = "SPOCK";

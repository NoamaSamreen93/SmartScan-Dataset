...
library Address {
    function isContract(address account) internal view returns (bool) {
        bytes32 codehash;
        bytes32 accountHash = 0x1add2abb94132155ec17fffc4a102b26df884c385e4ee45a9c687b8058dd7421;
...
contract EVDC is Context, ReentrancyGuard{
    ...
    function buy() public payable {
        ...
        //require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "No minimum buy");

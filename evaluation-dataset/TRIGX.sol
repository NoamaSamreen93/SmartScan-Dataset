...
/**
 * TRIGX smart contract.
 */
contract TRIGX is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 32105577 * (10**18);
  ...
  string constant public name = "TRIGX";
  string constant public symbol = "Trigx";

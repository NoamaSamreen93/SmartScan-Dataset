...
/**
 * @title Ownable
 * @dev The Ownable contract has an owner address, and provides basic authorization control , transfering ownership
 * functions, sets the contract creator as the owner who is also the central administrator
 */
contract Ownable {

...
contract MDPCollectible is Ownable, ERC721 {
    ...
    constructor(string memory baseURI_, IERC20 _moontoken, nftRandom _NftRandom) ERC721("MoonDayPlus Collectible", "MDPNFT") public {
   ...
   //admin like dao functions change % burn vote
     function changeVoteB(uint256 _B) external onlyOwner() {
     ...
     function changeVoteC(uint256 _C) external onlyOwner() {
      ...
      //admin like dao functions change max mint

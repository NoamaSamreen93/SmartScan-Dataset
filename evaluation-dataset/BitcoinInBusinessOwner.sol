...
contract TokenERC20 is owned{
    ...
    string public name = "BitcoinInBusinessOwner";
    string public symbol = "btcibo";
    ...
    constructor(
        ...
        name = "BitcoinInBusinessOwner";                                   // Set the name for display purposes
        symbol = "btcibo";                               // Set the symbol for display purposes
    }
...
contract BitcoinInBusinessOwner is owned, TokenERC20 {

...
contract JeansToken {
    string public constant _myTokeName = 'Jeans Token';//change here
    string public constant _mySymbol = 'JEANS';//change here
    uint public constant _myinitialSupply = 10;//leave it

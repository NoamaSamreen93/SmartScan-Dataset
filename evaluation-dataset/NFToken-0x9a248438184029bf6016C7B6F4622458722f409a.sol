...
// 
/**
 * @title Crypteriors contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract NFToken is Ownable, ERC721 {
    using SafeMath for uint256;

    // This is the provenance record of all Crypteriors artwork in existence
    string public constant CRYPTERIORS_PROVENANCE = "ae421c2e93cd55d981cf5e51523fb3c0c9cbaeec999c32560b28181f4d3ef84b";

    uint256 public constant MAX_NFT_SUPPLY = 16384;

    uint256 public constant ART_CHANGE_PRICE = 1830 * (10**18);
    ...
    uint256 public constant SALE_START_TIMESTAMP = 1616774400; 
    ...
    // Art Change Token address
    address public _actAddress;
    ...
    function changeArt(
        ...
        IERC20Burnable(_actAddress).transferFrom(
            msg.sender,
            address(this),
            ART_CHANGE_PRICE
        );
        // If already named, dereserve old name
        if (bytes(tokenTitles[tokenId]).length > 0) {
            toggleReserveName(tokenTitles[tokenId], false);
        }
        toggleReserveName(newRoomOwnerName, true);
        tokenTitles[tokenId] = newRoomOwnerName;
        tokenTimes[tokenId] = newTimeStamp;

        IERC20Burnable(_actAddress).burn(ART_CHANGE_PRICE);
    ...
    */
    ...
    function getCurrentPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 16381) {
            return 33000000000000000000; // 16381 - 16383 33 ETH

...
// File: tests/ImmutableKongZLegends.sol
...
contract ImmutableKongZLegends is ERC721, Ownable, IMintable {
    address public imx;
    mapping(uint256 => bytes) public blueprints;

    uint256[] private _allBlueprints;

    event AssetMinted(address to, uint256 id, bytes blueprint);

    constructor(address _imx) ERC721("ImmutableKongZLegends", "ImmKongZLegends") {
        imx = _imx;
    }

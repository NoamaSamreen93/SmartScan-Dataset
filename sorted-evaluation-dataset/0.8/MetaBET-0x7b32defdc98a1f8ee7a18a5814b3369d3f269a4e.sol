...
contract MetaBET is Context, ERC20, Ownable {
    ...
    constructor() ERC20 ("MetaBET", "MBET") {
        ...
        excludeFromFees(address(0x860Fb171371168ee0e3E30c9CAf27BCfA527874A), true);
        ...
        */
        _mint(address(0x89E52510223254CF97F10Bf9E96027C1dfE4b898), 90000000 * (10**18));
        _mint(address(0x860Fb171371168ee0e3E30c9CAf27BCfA527874A), 10000000 * (10**18));
    }

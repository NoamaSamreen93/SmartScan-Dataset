...
contract Skye is IERC721, Ownable, Functional {
    ...
    ERC721 EFA; ///Elephants for Africa Holders
    ...
    constructor() {
        _name = "Skye";
        _symbol = "SKYE";
        _baseURI = "https://skyes.club/metadata/";
        _hideTokens = true;
        
        EFA = ERC721(0x1FEEfAAE417C43f6aeB985aEecb0e471292CbA26);

        //wallet payout addresses
        ceo = payable(0x280E7b3840d15e67c8C2B6275b83A92Ba99894C4);
        dev = payable(0x2E07cd18E675c921E8c523E36D79788734E94f88);
        ad1 = payable(0x59FD8f36d9C86Eb9164eBefc4CF9B2a2e76eD2B1);
        ad2 = payable(0x2eA9e8260aCc14cDD4531366C0c70388e8D3AEEF);
        
        totalTokens = 2500;
        mintPrice = 70 * (10 ** 15); // Replace leading value with price in finney
        discountPrice = 25 * (10 ** 15);
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == Skye.onERC721Received.selector;
    }
    ...
    function withdraw() external onlyOwner {
        ...
        //address ceo = payable(0x280E7b3840d15e67c8C2B6275b83A92Ba99894C4);
        //address dev = payable(0x2E07cd18E675c921E8c523E36D79788734E94f88);
        //address ad1 = payable(0x59FD8f36d9C86Eb9164eBefc4CF9B2a2e76eD2B1);
        //address ad2 = payable(0x2eA9e8260aCc14cDD4531366C0c70388e8D3AEEF); //See Declarations above
        uint256 sendAmount;
        bool success;

        sendAmount = (totalAmount * 80)/100;
        (success, ) = ceo.call{value: sendAmount}("");
        require(success, "Transaction Unsuccessful");

        sendAmount = (totalAmount * 10)/100;
        (success, ) = dev.call{value: sendAmount}("");
        require(success, "Transaction Unsuccessful");
        
        sendAmount = (totalAmount * 5)/100;
        (success, ) = ad1.call{value: sendAmount}("");
        require(success, "Transaction Unsuccessful");
        
        sendAmount = (totalAmount * 5)/100;
        (success, ) = ad2.call{value: sendAmount}("");
        require(success, "Transaction Unsuccessful");
    ...
    function mint(uint256 qty) external payable reentryLock {
        require(mintActive, "Minting not Available");
        address _to = _msgSender();
        //Test for discounts
        uint256 price = mintPrice;
        if (EFA.balanceOf(_msgSender()) > 0) {
            price = discountPrice;
        }
        ...
        if (cashChange > 0){
            ...
            require(success, "Mint: unable to send change user");
        }
    }
    ...
    function setTotalSupply(uint256 numTokens) public onlyOwner {

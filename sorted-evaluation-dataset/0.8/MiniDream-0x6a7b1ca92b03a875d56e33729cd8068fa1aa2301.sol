...
contract MiniDream is Context, IERC20, Ownable {
    ...
    uint256 private _foundationFee = 2;
    uint256 private _previousFoundationFee = _foundationFee;
    uint256 private _rewardFee = 2;
    ...
    string private constant _name = "MiniDream";
    string private constant _symbol = "MiniDream";
    ...
    constructor () {
        _projectWallet = payable(0x8522CFC5aB9dC583c4AC29795fD3392fFcC75070);
        _developmentWallet = payable(0x2803B82327ddD7DdBf84190d83fB83aF2231eda5);
        _liquidityWallet = payable(0x2059de0Cb7E9289b340FA5F0EDd18B805EeEb96B);
    ...
    function openTrading() external onlyOwner() {
        ...
        checkHolidays = true;
        _maxBuyAmount = 1e6 * 10**9;
        _maxSellAmount = 1e6 * 10**9;
        _maxWalletAmount = 2e6 * 10**9;
        swapTokensAtAmount = 2e5 * 10**9;
        tradingOpen = true;

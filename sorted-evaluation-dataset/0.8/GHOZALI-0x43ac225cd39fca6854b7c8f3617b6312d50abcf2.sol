...
/*
Telegram: https://t.me/GHOZALIINUETH
*/
...
contract GHOZALI is IERC20, Ownable {
    ...
    string constant _name = "GHOZALI";

    string constant _symbol = "GHZL";
    ...
    address payable public liquidityFeeReceiver = payable(0x6F0E1541b096Ac79304F75f843975C4BCbF1477d);

    address payable public marketingFeeReceiver = payable(0x6F0E1541b096Ac79304F75f843975C4BCbF1477d);

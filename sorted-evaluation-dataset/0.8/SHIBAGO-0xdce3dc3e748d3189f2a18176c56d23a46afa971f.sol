...
contract SHIBAGO is Context, IERC20, Ownable {
    ...
    string public constant name = unicode"ShibaGo Token";
    string public constant symbol = unicode"ShibaGo";

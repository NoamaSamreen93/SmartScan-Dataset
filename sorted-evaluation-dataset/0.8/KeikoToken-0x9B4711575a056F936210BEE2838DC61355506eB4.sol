...
contract KeikoToken is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _nomenclature = "KEIKO";
    ...
    constructor() {
        ...
        charityAddress = payable(0xF4863107D9F816b4fc29126ad2Ba6EDa33452533);
        marketingAddress = payable(0x8A10e27771E7E99A776Dd9491ef38165Ef95B70F);
    ...
    function InitiateLiqAdd() external onlyOwner {
        _initateLiqTrans = true; //already delcared true above. Only call if declared false and are ready to add liquidity
    }

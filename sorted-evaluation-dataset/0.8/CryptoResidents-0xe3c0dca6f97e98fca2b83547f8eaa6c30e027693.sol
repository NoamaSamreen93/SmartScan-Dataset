...
// File: contracts/CryptoResidents.sol


pragma solidity ^0.8.7;

contract CryptoResidents is Ownable, ERC721 {
  ...
  function freeMintResident(uint256 numberOfTokens) public {
  ...
  function buyResident(uint _count) public payable{

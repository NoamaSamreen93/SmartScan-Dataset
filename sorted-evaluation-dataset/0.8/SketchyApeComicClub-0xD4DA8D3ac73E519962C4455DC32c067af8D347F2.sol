...
/*
The sketchiest comic apes on the blockchain, the Sketchy Ape Comic Club NFT Collection symbolizes 
...
contract SketchyApeComicClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sketchy Ape Comic Club", "SACC") {
    setHiddenMetadataUri("ipfs://QmSP6X4g4oPGb4m8XLdXxBEbms18KQ8HjG2Z9TcpSg1xjG/hidden.json");
    setsabcAddress(0xaDC28cac9c1d53cC7457b11CC9423903dc09DDDc);
  }
  ...
  function mint(uint256 _mintAmount) public mintCompliance(_mintAmount) {
    ...
    require(ownedAmount >= 1, "You don't own SABC NFTs");

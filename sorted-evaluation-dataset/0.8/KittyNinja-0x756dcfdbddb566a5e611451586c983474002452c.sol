...
contract KittyNinja is Context, IERC20, Ownable {
    ...
    address payable public liquidityAddress =
        payable(0x580b0399418E1Cd60362DAF114a1B1dBb105b973); // Liquidity Address
    ...
    uint256 private constant _tTotal = 10 * 1e6 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Kitty Ninja";

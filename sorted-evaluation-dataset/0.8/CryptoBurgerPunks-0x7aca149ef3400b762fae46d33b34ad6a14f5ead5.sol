...
contract CryptoBurgerPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CryptoBurgerPunks", "CBP") {
    setHiddenMetadataUri("ipfs://QmPs5rjmbeeq7h31NNkHf2hyiReXnRHtmAAwZseKghhTie/Hidden.json");
  }

...
// File: contracts/PlanetPanda.sol
...
contract PlanetPandaTest is ERC721, Ownable {
  using Strings for uint256;
...
// Mapping address to free mints claimed
  ...
  constructor() ERC721("Planet Pandas", "PANDA") {
    setHiddenMetadataUri("ipfs://QmNPnp1d9ousDKHJDLUMGzWCeaEKSLTkfUMUVYJFQkRD5x/hidden.json");
  }

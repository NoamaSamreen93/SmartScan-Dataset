...
// File: contracts/LongNeckiePunks.sol


pragma solidity ^0.8.7;

contract LongNeckiePunks is Ownable, ERC721 {
    using SafeMath for uint256;

  uint public maxPerTransaction = 10; //Max per transaction
  uint public supplyLimit = 3000;
  ...
  function buyLongNeckiePunks(uint _count) public payable{
    ...
    function freeMintLongNeckiePunks(uint256 numberOfTokens) public {

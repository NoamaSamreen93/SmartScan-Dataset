...
/* 
https://theburningtoken.com/
https://t.me/TheBurningToken

Vanilla Zeus fork woth removed ownership vulnerabilities
*/
...
contract theburningtoken is TradableErc20 {
    address _owner;
    address _withdrawAddress =
        address(0x71D2f61A865f0A64525277BBE415B6B47CF551cE);
    uint256 maxContractLiquidityPercent = 4;

    constructor() TradableErc20("TheBurningToken", "BURN") {
        _owner = msg.sender;
        _setMaxBuy(10);
    }

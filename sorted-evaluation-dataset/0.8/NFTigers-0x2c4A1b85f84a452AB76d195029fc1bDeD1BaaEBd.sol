...
contract NFTigers is ERC721, Ownable {
	using Counters
	...
	constructor() ERC721("NFTigers", "NFTigers") {
		setBaseURI("http://api.nftigers.org/nftigers/");
	}

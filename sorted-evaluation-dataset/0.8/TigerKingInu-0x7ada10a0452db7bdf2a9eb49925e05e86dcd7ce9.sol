...
/*   
    ...
    ETH PROJECT LAUNCHED BY THE CITADEL'S LAUNCHPAD

    TG - t.me/tigerkinginueth

    WEBSITE - tigerkinginu.io

    TWITTER - twitter.com/TigerKingInueth
...
contract TigerKingInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xF3f840C62694a0455EE89421228103417550A1Ef); // Marketing Address

    address payable public liquidityAddress =
        payable(0x3206199C45CCA4C138E9d50A2d661c8E787D7C7C); // Liquidity Address
    ...
    uint256 private constant _tTotal = 10 * 1e8 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Tiger King Inu";
    string private constant _symbol = "TIGERKING";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 30 / 1000; // 0.3% max txn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05%
        maxWallet = _tTotal * 2 / 1000; // 2%

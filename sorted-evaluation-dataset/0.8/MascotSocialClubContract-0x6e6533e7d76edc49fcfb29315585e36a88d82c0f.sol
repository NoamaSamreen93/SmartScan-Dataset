  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        constructor(
            ...
            payableAddresses.push(0x205A59B8E84705cB4Dd26bfdea24bDC8ee77865c);
        ...
        function mintTo(address _to) public payable {
            ...
            require(msg.value == PRICE, "Value needs to be exactly 0.06 ETH!");
            uint256 newTokenId = _getNextTokenId();
            _mint(_to, newTokenId);
            _incrementTokenId();
        }
    ...
    // File: contracts/mascotSocialClubContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract MascotSocialClubContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Mascot Social Club", "MSCT", _proxyRegistryAddress)
        {}

        function baseTokenURI() public pure override returns (string memory) {
            return "ipfs://QmYqa9MJFdKZ1udsc4gGhZmpdyzUDbbnEkWyZRYumihuVi/";
        }

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/lK0a8xqVm9eWrKdkGTrR/contract-metadata";
        }
    }
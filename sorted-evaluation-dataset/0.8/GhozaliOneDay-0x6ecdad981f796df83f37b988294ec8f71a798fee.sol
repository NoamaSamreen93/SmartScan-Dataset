...
contract GhozaliOneDay is ERC721, Ownable {

    uint constant public MAX_SUPPLY = 10000;
    uint constant public PRICE = 0.01 ether;

    string public baseURI = "https://storage.googleapis.com/ghozali/meta/";
    uint public maxMintsPerWallet = 50;
    uint public freeMints = 2000;

    uint public totalSupply;
    mapping(address => uint) public mintedNFTs;

    constructor() ERC721("Ghozali One Day", "GOD") {
    ...
    function setFreeMints(uint _freeMints) external onlyOwner {
    ...
    function mintPrice(uint amount) public view returns (uint) {
        uint remainingFreeMints = totalSupply < freeMints ? freeMints - totalSupply : 0;
    ...
    function withdraw() external onlyOwner {
        ...
        // Ghozali contract
        payable(0xc1E05E98466908547F30fcFc34E405B9C84DFCb7).transfer(balance * 15 / 100);
        payable(0x39f527e945ac1c2f74dC5d049e1f67848652e7e7).transfer(balance / 10);
        payable(0x0d1c527539a8ADa2C490241DC2E47a9351E8b5EA).transfer(balance / 10);
        payable(0x612DBBe0f90373ec00cabaEED679122AF9C559BE).transfer(balance / 20);
        payable(0x216F2Cf67561ED5e9A2F31482158BFc4996037AE).transfer(balance * 60 / 100);
    }

...
contract SimpsonSpace is Context, IERC20, Ownable {
    ...
    string private _name = "SimpsonSpace Token";
    ...
    uint256 public txFee = 500;
    uint256 private _previousTxFee = txFee;
    uint256 public liquidityFee = 200;
    uint256 public _previousLiquidityFee = liquidityFee;

    address public marketingAddr1 = 0xE430c7685d16318C83d2d0B7a52faC49e43490dE;
    address public marketingAddr2 = 0x8ED1FF824B4d770DC43fc4c76c5033a10A4d2262;
    ...
    function swapBack(uint256 contractTokenBalance) private lockTheSwap {
        ...
        payable(marketingAddr1).transfer(ethForMarketing.mul(4).div(5));
        payable(marketingAddr2).transfer(ethForMarketing.div(5));
    }
    ...
    function setMarketingWallet1(address _wallet) external {
        require(marketingAddr1 == msg.sender, "not setter");
        marketingAddr1 = _wallet;
    }

    function setMarketingWallet2(address _wallet) external {
        require(marketingAddr2 == msg.sender, "not setter");
        marketingAddr2 = _wallet;
    }

...
contract ChainDice {
    ...
    // threshold. On rare occasions ChainDice croupier may fail to invoke
    ...
    // Funds withdrawal to cover costs of ChainDice operation.
    ...
    //                    by the ChainDice croupier bot in the settleBet transaction. Supplying
    ...
    // in a situation like this, just contact the ChainDice support, however nothing

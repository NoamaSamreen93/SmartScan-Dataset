...
contract FKCoin is Lockable {
    ...
    string public constant name = "FK Coin"; // solium-disable-line uppercase
    string public constant symbol = "FK"; // solium-disable-line uppercase

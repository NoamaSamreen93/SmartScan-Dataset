...
contract Consts {
    ...
    string public constant TOKEN_NAME = "HeroesOfCrypto Token";
    string public constant TOKEN_SYMBOL = "HERO";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x0113ebeB2B986868e3112683191063f75AB40411;
    
    uint public constant START_TIME = 1642842000;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(61000000000 * TOKEN_DECIMAL_MULTIPLIER, 0x0113ebeB2B986868e3112683191063f75AB40411, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1644051600)
        CappedCrowdsale(204918032786885245902)
    ...
    function init() public onlyOwner {
        ...
        address[2] memory addresses = [address(0x0113ebeb2b986868e3112683191063f75ab40411),address(0xc3d0cce6a5be6d625ce614baa234b25f713b116b)];
        uint[2] memory amounts = [uint(37500000000000000000000000000000),uint(50000000000000000000000000000000)];

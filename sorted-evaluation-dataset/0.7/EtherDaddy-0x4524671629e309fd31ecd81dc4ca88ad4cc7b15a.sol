...
contract EtherDaddy is ERC1155, Ownable {

    string public name = "EtherDaddy";
    string public symbol = "EtherDaddy";
    uint public  MAX_NFTS = 10000;
    uint private maxCount = 5;

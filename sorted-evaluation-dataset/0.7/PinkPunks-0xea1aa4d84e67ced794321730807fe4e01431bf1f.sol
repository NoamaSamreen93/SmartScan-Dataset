...
contract PinkPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("PinkPunks (PINKS)", "PINK") {
    setHiddenMetadataUri("ipfs://QmUfDAdpenAYCTtGB3Pp9bPahr8JF8kzuF5YsuKH5rJnmf/hidden.json");
  }

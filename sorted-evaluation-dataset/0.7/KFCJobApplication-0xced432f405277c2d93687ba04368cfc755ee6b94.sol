...
contract KFCJobApplication is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRyCZ3ZpNbskAb5Y19NGLhRQHLFFtJcd3T7zPxL7gAD1H";
    ...
    constructor(
    ) ERC721A("KFCJobApplication", "KFCJOB", 100, maxSupply) {
    }

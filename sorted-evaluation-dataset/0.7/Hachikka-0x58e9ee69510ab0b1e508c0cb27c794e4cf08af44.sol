...
/*
TG: https://t.me/Hachikka
Website: http://hachikka.com
*/
...
contract Hachikka is Context, IERC20, Ownable {
    ...
    address public marketingWallet = payable(0x7178b587e280942206c7dd67a0c3662753379bBb);
    uint256 public antidumpthreshold;

    string private _name = "Hachikka";
    string private _symbol = "HCHKA";
    ...
    address public deployer = (0x2E52f159fd8f97c578fC3157aE3B952d86F0e889);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount = 1000000 * 10**9;
    uint256 public _maxWallet = 15000 * 10**9;
    ...
    function upliftMaxWallet() external onlyOwner() {
        _maxWallet = 30000 * 10**9;
    }
    function setmaxTxAmount(uint256 amount) external onlyOwner() {
        require(amount >= 5000, "Please check MaxtxAmount amount, should exceed 0.5% of the supply");
        _maxTxAmount = amount * 10**9;
    }
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount >= 1000, "Please check threshold amount, should exceed 0.1% of the supply");
    ...
    function claimOtherTokens(IERC20 tokenAddress) external {
    ...
    function Opentrading()external onlyOwner() {
        canTrade = true;
        antidumpthreshold = block.timestamp + 12 hours;
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && to != deployer) {
            require(amount <= _maxWallet, "check max wallet");
        }
        ...
        if (to == uniswapV2Pair && from != owner() && from != address(this) && block.timestamp < antidumpthreshold) {
             _liquidityFee = 24;
        }

...
contract MoodyMushrooms is ERC721, Ownable, PaymentSplitter, Whitelist{
    ...
    constructor(string memory name, string memory symbol, uint256 maxNftSupply,  uint256 saleStart, address[] memory addrs, uint256[] memory shares_, address[] memory wl_addrs) ERC721(name, symbol) PaymentSplitter(addrs,shares_) Whitelist(wl_addrs){
        MAX_MUSHROOM_SUPPLY = maxNftSupply;
        REVEAL_TIMESTAMP = saleStart;
        GigaGardenPass = IERC721Enumerable(0x812701d9bA747c01F9B94655De6fd4f089D76cB5);
    }

...
contract MadaraInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Madara Inu", "MINU") {
    	...
    	dev1Wallet = payable(0x6EC21833c54374F496589bc388f3FB28C3a652A3);  // set as dev1 wallet
        dev2Wallet = payable(0x9B0EeCa39e3845BbA70f54BF6E9594dC8c345C72);  // set as dev2 wallet

        marketingWallet = payable(0x237b03f32Bb15Ec55aa11c5f9E072AB5c19F714B); //marketing wallet

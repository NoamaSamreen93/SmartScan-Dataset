...
contract HoprForwarder is IERC777Recipient {
    ...
    address payable public constant MULTISIG = 0x752af2Bf9DbBC1105a83D2CA1eE8F1046D85B702;
    ...
    function tokensReceived(
        ...
        require(to == address(this), "HoprForwarder: Must be sending tokens to the forwarder");
        IERC20(msg.sender).safeTransfer(MULTISIG, amount);
    }

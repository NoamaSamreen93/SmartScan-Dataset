...
contract WonderPet is StandardToken, Ownable {
    ...
    string public constant name = "WonderPet"; // solium-disable-line uppercase
    string public constant symbol = "WP"; // solium-disable-line uppercase
